...
По-долу е структурираният технически преглед на правилата за мета индексация, самонасочените canonical тагове, обработката на параметри и стратегията за индексиране на търсения/филтри, извлечен от одита.

---

## Meta index, follow

**Категория:** Indexation | **Екип:** Dev team | **Тип:** Техническа
...
Пример: https://befit.bg/zdrave/lekarstva/nastinka-grip - вижте как е направен "Филтър по проблем". Изцяло уникални страници с мета данни, адреси, canonical и т.н. Тоест, клиентът може да ранкира за тях.
{% /recommendation %}
...
По-долу е даден пример за правилно HTML внедряване на директивите за индексация и canonical:
