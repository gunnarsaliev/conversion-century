...
{% recommendation %}
Грежеш lang таг в HTML-a. В момента HTML lang ="bg" е грешно, защото сайтът е на английски. Трябва да се коригира на HTML lang ="en".
{% /recommendation %}
...
{% recommendation %}
В момента сайта има и английска версия, но повечето неща не са преведени. Това създава дублирано съдържание. Препоръчително е да се премахме анлийската версия на този етап. След като оптимизираме страниците и добавим съдържание, ще се добави отново езиковата версия с напълно преведени страници.
{% /recommendation %}
