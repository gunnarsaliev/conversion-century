...
import seoScoreImage from '@/images/seo-score.png'
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Comprehensive technical SEO audit recommendations and implementation guidelines for website optimization.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/docs/technical-seo/general">Get started</Button>
                <Button href="/docs/technical-seo/schema-markup" variant="secondary">
                  View Schema Markup
                </Button>
              </div>
            </div>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              {/* <Image src={seoScoreImage} alt="SEO Score" width={400} height={300} /> */}
            </div>
          </div>
        </div>
      </div>
